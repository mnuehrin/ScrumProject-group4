              ...
              {campaigns.map((c) => {
                ...
                return (
                  <button
                    ...
                    className={`group flex w-full flex-col items-start gap-1.5 rounded-lg px-4 py-3 text-left transition-colors border ${isSelected
                  ...
                  >
                    <div className="flex w-full items-center justify-between gap-2">
                      ...
                      <span
                        ...
                        className={`h-2 w-2 shrink-0 rounded-full ${c.status === "LIVE" ? "bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.4)]" :
              ...
              <div className="flex flex-col gap-4 border-b border-border pb-5 md:flex-row md:items-start md:justify-between">
                <div className="space-y-2">
                  <div className="flex items-center gap-3">
                    ...
                    <Badge className="bg-accent/50 hover:bg-accent/50 text-xs">
                  ...
                  {(["DRAFT", "LIVE", "ARCHIVED"] as Campaign["status"][]).map((status) => {
                    ...
                    return (
                      <button
                        ...
                        className={`relative rounded-md px-3.5 py-1.5 text-xs font-medium transition-all duration-200 ${isActive
